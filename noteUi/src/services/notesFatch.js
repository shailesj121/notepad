...
export const postNote = async (url, data) => {
    try {
        ...
        return await axios.post(`${Varcel_Auth_Url}${url}`, data,) //for Varcel Fatch
...
export const getNotes = async (url, userId) => {
    try {
        ...
        return await axios.get(`${Varcel_Auth_Url}${url}`, {
            headers: {
...
export const deleteNote = async (url, data) => {
    try {
        ...
        return await axios.delete(`${Varcel_Auth_Url}${url}`, data)
...
export const UpdateNote = async (url, data) => {
    try {
        ...
        return await axios.put(`${Varcel_Auth_Url}${url}`, data)
    } catch (error) {
        console.log(error)
    }
}
